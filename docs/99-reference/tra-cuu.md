...
⏳ = chưa thiết kế DDL chi tiết, thuộc Sprint 7 — xem [ranh giới phạm vi ở mục 5.11](../README.md#tình-trạng-hoàn-thiện).
...
|---|---|---|---|
| 1 | Mỗi bảng khai báo grain bằng một câu, không có chữ "và" | `UNIQUE` constraint trên cột định nghĩa grain ([5.4](../03-ddl/00-init.md#4-chiến-lược-khoá-và-ràng-buộc)) | DQ-UNIQ-001 |
...
| 3 | Không lưu tỷ lệ trong fact, chỉ lưu tử số và mẫu số | Rà cột khi review DDL ([2.6](../01-erd/grain.md#additivity-của-measure)) | Không có cột `*_pct`, `*_rate` trong `dm.fact_*` |
